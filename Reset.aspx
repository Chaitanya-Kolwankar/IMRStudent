<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reset.aspx.cs" Inherits="resetPAss" %>
                    ...
                    <div class="panel-body">
                        <form role="form" runat="server">
                            ...
                            <form id="maskForm" method="post" class="form-horizontal">
                                ...
                                <asp:Button ID="btnLogin" runat="server" Text="RESET" CssClass="btn btn-lg btn-success btn-block" OnClick="btnLogin_Click" />
                                <div class="form-group">
                                    <div class="form-control">
                                        <center> <a style="font-weight:700" href="http://183.87.70.6/student/">To Login Click Here</a></center>
                                    </div>
                                </div>
                            </form>
                        </form>
