...
public partial class photocopy_form : System.Web.UI.Page
{
    DataSet ds;
    DataTable dt;
    ...
    public string getWhileLoopData()
    {
        ...
        filltable = "select subject_name,paper_code,marks_obtained from PR_Details where stud_id='" + transid.Substring(0, 8) + "'  and sem_id='" + arr[2].ToString() + "' and ext2='" + arr[1].ToString() + "' and ext3='" + dtpro.Rows[0]["ayid"].ToString() + "' and photocopy_flag=1 and del_flag=0";
