...
public partial class documents : System.Web.UI.Page
{
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                for (int j = 0; j < ds.Tables[1].Rows.Count; j++)
                {
                    ...
                    if (ds.Tables[2].Rows[0]["app_type"].ToString() == "FE")
                    {
                        ...
                        hostedlink = "http://localhost:4878/" + ds.Tables[2].Rows[0]["ayid"].ToString() + "_DOC/" + ds.Tables[2].Rows[0]["Form_no"].ToString() + "/" + ds.Tables[1].Rows[j]["doc_name"].ToString() + ".jpg";
    ...
    protected void btnmodal_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript", "<script>$('#myModal').modal({backdrop: 'false'});</script>", false);
        //ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript","$('#myModal').modal('show');", true);
