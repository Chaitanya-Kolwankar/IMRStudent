<%@ Page Language="C#" AutoEventWireup="true" CodeFile="photocopy_form_off.aspx.cs" Inherits="photocopy_form_off" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div style="font-size: 18px; margin-top: 5px; text-align: center">
                <span style="border-bottom: 1px solid black">APPLICATION FOR THE <span style="font-weight: bold">PHOTOCOPY</span> OF ASSESSED ANSWER BOOKS.</span>
            </div>
           ...
           <table class="table table-bordered" style="text-align: center">
            ...
            <p style="margin-bottom: 3px;">
                <span style="border-bottom: 1px solid black">Photocopy Rules :-</span>
            </p>
            <ol>
                ...
                <li>Fees 10/- for Photocopy Form Process.
                </li>
                <li>Fees 25/- per subject for S.C.,S.T.,D.T./N.T. CategoryStudents.
                    (Caste Certificate if Compulsory)
                </li>
                <li>Fees 50/- per subject for OPEN / OBC Category Students
                </li>
            </ol>
            <%-- <table class="table table-bordered" style="text-align:center">
